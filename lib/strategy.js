...
//
//   params: JSON object which may include:
//     gatehub_name: username at GateHub
//     cip_started_at: epoch time of when CIP started at GateHub
//     cip_finished_at: epoch time of when CIP successfully finished at GateHub
...
Strategy.prototype.authorizationParams = function(options) {
  ...
  if (options.params) {
    response.params = JSON.stringify(options.params);
  }
